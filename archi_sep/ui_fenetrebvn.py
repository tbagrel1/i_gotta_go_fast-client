...
class Ui_FenetreBVN(object):
    def setupUi(self, FenetreBVN):
        ...
        FenetreBVN.setMinimumSize(QtCore.QSize(600, 300))
        FenetreBVN.setMaximumSize(QtCore.QSize(600, 300))
        self.LabelIcone = QtGui.QGraphicsView(FenetreBVN)
        self.LabelIcone.setGeometry(QtCore.QRect(20, 20, 561, 91))
        self.LabelIcone.setObjectName(_fromUtf8("LabelIcone"))
        self.LabelDescription = QtGui.QLabel(FenetreBVN)
        self.LabelDescription.setGeometry(QtCore.QRect(20, 120, 561, 51))
        font = QtGui.QFont()
        ...
        self.LabelCredits.setGeometry(QtCore.QRect(20, 249, 561, 31))
        font = QtGui.QFont()
        ...
        self.BoutonQuitter.setGeometry(QtCore.QRect(20, 190, 271, 41))
        font = QtGui.QFont()
        ...
        self.BoutonContinuer.setGeometry(QtCore.QRect(310, 190, 271, 41))
        font = QtGui.QFont()
        font.setPointSize(15)
