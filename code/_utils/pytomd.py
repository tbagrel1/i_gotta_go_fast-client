...
file_t_b = open("../_sources_doc/.{}_comm_temp.py".format(("main.py")[:-3]), "w")
...
file_s_b = open("../_sources_doc/.{}_comm_temp.py".format(("main.py")[:-3]), "r")

file_d_b = open("../_sources_doc/{}_comm.md".format(("main.py")[:-3]), "w")
...
file_d_b.close()
os.system("rm ../_sources_doc/.{}_comm_temp.py".format(("main.py")[:-3]))
