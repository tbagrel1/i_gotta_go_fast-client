...
def parserRang(nom_fichier_rang):
    fichier_rang = open("_sources_score/" + nom_fichier_rang + ".csv", "r")
    ...
    fichier_rang_comp = open("score/" + nom_fichier_rang + ".db", "w")
    pickle.dump(liste_dico_rang, fichier_rang_comp)
    fichier_rang_comp.close()

def getRang(nom_fichier_rang):
    fichier_rang_comp = open("score/" + nom_fichier_rang + ".db", "r")
