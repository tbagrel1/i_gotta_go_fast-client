...
const QMetaObjectExtraData Score::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject Score::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_Score,
      qt_meta_data_Score, &staticMetaObjectExtraData }
};
