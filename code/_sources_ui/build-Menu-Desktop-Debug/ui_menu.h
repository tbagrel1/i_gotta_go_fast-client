...
public:
    ...
    void setupUi(QMainWindow *Menu)
    {
        ...
        FrameControles->setFrameShadow(QFrame::Plain);
        ...
        FramePseudo->setFrameShadow(QFrame::Plain);
    ...
    void retranslateUi(QMainWindow *Menu)
    {
        ...
        CheckBoxNoOnline->setText(QApplication::translate("Menu", "Je ne veux pas afficher mon score en ligne", 0, QApplication::UnicodeUTF8));
