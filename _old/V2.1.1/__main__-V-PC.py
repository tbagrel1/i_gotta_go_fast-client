...
:", initialdir=path.dirname(sys.argv[0]), initialfile="ListeMotsDefaut.txt",\
filetypes=[("Fichiers Textes","*.txt"),("Tous Types","*")], defaultextension=\
".txt", multiple=False, parent=Master)
